...
{
    public partial class FmENPNEliminar : Form
    {
        public FmENPNEliminar()
        {
            InitializeComponent();
        }
        ...
        private void FmENPNEliminar_Load(object sender, EventArgs e)
        {
            dvgLista.DataSource = ClassDataEN.MostrarLista();
        }
        ...
        {
            string id = TBId.Text;
            string comando = ClassBusinessEN.BTEliminarComando(id);
            ClassBusinessEN.BTEliminarLogica(comando, CommandType.Text);
            InvAvisoEliminado();
